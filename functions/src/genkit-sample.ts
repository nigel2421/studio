...
// automatically. If you are using Google Developer API (googleAI) you can get
// an API key at https://aistudio.google.com/app/apikey If you are using
// Google Vertex AI Express Mode (vertexAI with apiKey) you can get an API key
