...
export const sendPaymentReceipt = onCall({
    ...
    const { tenantEmail, tenantName, amount, date, propertyName, unitName, notes, tenantId, paymentMethod, transactionId } = request.data;
        ...
        html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    ${paymentMethod ? `<tr style="background-color: #f9f9f9;"><td style="padding: 10px; border: 1px solid #ddd;">Payment Method:</td><td style="padding: 10px; border: 1px solid #ddd;">${paymentMethod}</td></tr>` : ''}
                    ${transactionId ? `<tr><td style="padding: 10px; border: 1px solid #ddd;">Transaction ID:</td><td style="padding: 10px; border: 1px solid #ddd;">${transactionId}</td></tr>` : ''}
